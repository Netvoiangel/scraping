...
rec = requests.get(url, headers=headers1)

src = rec.text
print(src)

with open("index_2.html", encoding='utf-8', newline='') as file:
    src = file.read()
...
with open("all_categories_dict.json", "w", encoding="utf-8", newline='') as file:
    json.dump(all_categories_dict, file, indent=4, ensure_ascii=False)

with open("all_categories_dict.json", encoding="utf-8", newline='') as file:
...
for category_name, category_href in all_categories.items():
    ...
    req = requests.get(url = category_href, headers=headers1)
    src = req.text
